...
# idata = az.from_netcdf(dir + base_name + '/lyso_posterior.nc')
with lyso_model:
    # draw 4000 posterior samples
    # numpyro NUTS
    posterior_checks = pm.sample_posterior_predictive(idata, random_seed=rng)
az.to_netcdf(posterior_checks, dir + base_name + '/lyso_posterior_predictive.nc')

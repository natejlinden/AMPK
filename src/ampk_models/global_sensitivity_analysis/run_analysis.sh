...
python plot_trajectories.py ./ MA_double_mech ampk_MA_double_mech_diffrax \
    MA_double.json compute_MA_params 150 ../../../figures/
echo "done"
...
python plot_trajectories.py ./ MA_single_mech ampk_MA_single_mech_diffrax \
    MA_single.json compute_MA_params 150 ../../../figures/
echo "done"
...
python plot_trajectories.py ./ MM_double_mech ampk_MM_double_mech_diffrax \
    MM_double.json compute_MM_params 150 ../../../figures/
echo "done"
...
python plot_trajectories.py ./ MM_single_mech ampk_MM_single_mech_diffrax \
    MM_single.json compute_MM_params 150 ../../../figures/
echo "done"
...
python plot_trajectories.py ./ ampk_newmech_MA_single_diffrax \
    newmech_MA_single.json compute_newmech_MA_params 150 ../../../figures/
echo "done"

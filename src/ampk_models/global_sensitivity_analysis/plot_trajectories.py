...
fig_init.savefig(figdir + savedir + 'stress_responses_init.pdf', bbox_inches='tight')

ax_stress.set_ylim([0, 1.1])
ax_stress.set_xlabel('time (s)')
ax_stress.set_ylabel(r'$pAMPKAR/AMPKAR_{tot}$')
fig_stress.savefig(figdir + savedir + 'stress_responses_only.pdf', bbox_inches='tight')

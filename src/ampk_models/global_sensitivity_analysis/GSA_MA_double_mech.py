...
nsamps = 8
param_vals_sobol_MA = sobol_samp.sample(bounds_MA, nsamps, calc_second_order=False, seed=seed)
param_vals_sobol_MM = sobol_samp.sample(bounds_MM, nsamps, calc_second_order=False, seed=seed)

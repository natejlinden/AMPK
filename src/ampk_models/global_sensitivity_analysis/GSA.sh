...
# MM Single
python GSA_sampling.py -model MM_single_mech -free_params kOffAMP,kOffADP,kOffATP,kPhosCaMKK,KmCaMKK,kPhosLKB1,KmLKB1,kDephosPP,KmPP -model_info_file ../odes/MA_single.json -upper_mult 1e2 -lower_mult 1e-2 -metab_params_file ../odes/metabolism_params.json -nsamples 1024 -gsa_method sobol -savedir /tscc/lustre/ddn/scratch/nlinden/ampk

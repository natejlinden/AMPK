...
#python GSA_sampling.py 0.5 ./ MA_double_mech ampk_MA_double_mech_diffrax \
#    MA_double.json nominal_params_MA.csv param_bounds_MA.csv \
#    compute_MA_params

#echo "Sampling MA_single"
#python GSA_sampling.py 0.5 ./ MA_single_mech ampk_MA_single_mech_diffrax \
#    MA_single.json nominal_params_MA.csv param_bounds_MA.csv \
#    compute_MA_params

#echo "Sampling MM_double"
#python GSA_sampling.py 0.5 ./ MM_double_mech ampk_MM_double_mech_diffrax \
...
# python GSA_sampling.py 0.5 ./ MM_single_mech ampk_MM_single_mech_diffrax \
#     MM_single.json nominal_params_MM.csv param_bounds_MM.csv \
#     compute_MM_params

echo "Sampling newmech_MA_single"
python GSA_sampling.py 0.5 ./ newmech_MA_single ampk_newmech_MA_single_diffrax \

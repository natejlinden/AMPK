...
ampk_Coccimiglio=@ODEmodel(
    x1'(t)=(kGly*x2(t))-((((VforAK*x1(t)*x3(t))/(kmt*kmm))-((((VforAK*(kmd*kmd))/(KeqAK*kmt*kmm))*(x2(t)*x2(t)))/(kmd*kmd)))/(1+(x1(t)/kmt)+(x3(t)/kmm)+((x1(t)*x3(t))/(kmt*kmm))+((2*x2(t))/kmd)+((x2(t)*x2(t))/(kmd*kmd))))-(kHydro*x1(t))+((VmaxOxPhos*(((x2(t)*x2(t))/(Kadp*Kadp))))/(1+(((x2(t)*x2(t))/(Kadp*Kadp)))))-((((((VforCK*Kiq*Kp)/(KeqCK*Kia*Kb))*x1(t)*(TCr-x4(t)))/(Kiq*Kp))-((VforCK*x2(t)*x4(t))/(Kia*Kb)))/(1+(x2(t)/Kia)+(x4(t)/Kib)+(x1(t)/Kiq)+((x2(t)*x4(t))/(Kia*Kb))+(((TCr-x4(t))*x1(t))/(Kiq*Kp))))-(k6f*x1(t)*x12(t)-k6r*x6(t))-(k9f*x1(t)*x13(t)-k9r*x9(t)),
    x2'(t)=-(kGly*x2(t))+2*((((VforAK*x1(t)*x3(t))/(kmt*kmm))-((((VforAK*(kmd*kmd))/(KeqAK*kmt*kmm))*(x2(t)*x2(t)))/(kmd*kmd)))/(1+(x1(t)/kmt)+(x3(t)/kmm)+((x1(t)*x3(t))/(kmt*kmm))+((2*x2(t))/kmd)+((x2(t)*x2(t))/(kmd*kmd))))+(kHydro*x1(t))-((VmaxOxPhos*(((x2(t)*x2(t))/(Kadp*Kadp))))/(1+(((x2(t)*x2(t))/(Kadp*Kadp)))))+((((((VforCK*Kiq*Kp)/(KeqCK*Kia*Kb))*x1(t)*(TCr-x4(t)))/(Kiq*Kp))-((VforCK*x2(t)*x4(t))/(Kia*Kb)))/(1+(x2(t)/Kia)+(x4(t)/Kib)+(x1(t)/Kiq)+((x2(t)*x4(t))/(Kia*Kb))+(((TCr-x4(t))*x1(t))/(Kiq*Kp))))-(k7f*x2(t)*x12(t)-k7r*x7(t))-(k10f*x2(t)*x13(t)-k10r*x10(t)),
    x3'(t)=-((((VforAK*x1(t)*x3(t))/(kmt*kmm))-((((VforAK*(kmd*kmd))/(KeqAK*kmt*kmm))*(x2(t)*x2(t)))/(kmd*kmd)))/(1+(x1(t)/kmt)+(x3(t)/kmm)+((x1(t)*x3(t))/(kmt*kmm))+((2*x2(t))/kmd)+((x2(t)*x2(t))/(kmd*kmd))))-(k8f*x3(t)*x12(t)-k8r*x8(t))-(k11f*x3(t)*x13(t)-k11r*x11(t)),

ode = @ODEmodel( 
    ...
    x4'(t) = -((kCaMKK*CaMKKtot*x4(t))/(KmCaMKK + x4(t))) - ((kLKB1*LKB1tot*x4(t))/(KmLKB1 + x4(t))) + ((kPP*PPtot*S)/(KmPP + S)),
    x5'(t) = ((kCaMKK*CaMKKtot*x4(t))/(KmCaMKK + x4(t))) + ((kLKB1*LKB1tot*x4(t))/(KmLKB1 + x4(t))) - ((kPP*PPtot*S)/(KmPP + S)),

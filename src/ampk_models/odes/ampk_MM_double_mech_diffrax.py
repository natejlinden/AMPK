...
class MM_double_mech(eqx.Module):
    ...
    def __call__(self, t, y, args):
        ...
        KmCaMKK     = args[7]
        kPhosLKB1       = args[8] # LKB1
        KmLKB1      = args[9]
        kDephosPP         = args[10] # AMPK Phosphatase
        KmPP        = args[11]
        kPhosAMPK       = args[12] # AMPK kinase
        KmAMPK      = args[13]
        kDephosPP1        = args[14] # pAMPKAR Phosp  hatase
        KmPP1       = args[15] 
        ...
        J25 = (kPhosCaMKK*CaMKKtot*y[3])/(KmCaMKK + y[3]) # CaMKK phosphorylation
        J26 = (kPhosCaMKK*CaMKKtot*y[5])/(KmCaMKK + y[5])
        J27 = (kPhosCaMKK*CaMKKtot*y[6])/(KmCaMKK + y[6])
        J28 = (kPhosCaMKK*CaMKKtot*y[7])/(KmCaMKK + y[7])
        J29 = (kPhosCaMKK*CaMKKtot*y[11])/(KmCaMKK + y[11])
        J30 = (kPhosCaMKK*CaMKKtot*y[12])/(KmCaMKK + y[12])
        J31 = (kPhosCaMKK*CaMKKtot*y[13])/(KmCaMKK + y[13])
        J32 = (kPhosCaMKK*CaMKKtot*y[14])/(KmCaMKK + y[14])
        J33 = (kPhosCaMKK*CaMKKtot*y[15])/(KmCaMKK + y[15])
        J34 = (kPhosCaMKK*CaMKKtot*y[16])/(KmCaMKK + y[16])
        J35 = (kPhosLKB1*LKB1tot*y[5])/(KmLKB1 + y[5])
        J36 = (kPhosLKB1*LKB1tot*y[6])/(KmLKB1 + y[6])
        J37 = (kPhosLKB1*LKB1tot*y[11])/(KmLKB1 + y[11])
        J38 = (kPhosLKB1*LKB1tot*y[12])/(KmLKB1 + y[12])
        J39 = (kPhosLKB1*LKB1tot*y[14])/(KmLKB1 + y[14])
        J40 = (kDephosPP*PPtot*y[4])/(KmPP + y[4])
        J41 = (kDephosPP*PPtot*y[10])/(KmPP + y[10])
        J42 = (kDephosPP*PPtot*y[22])/(KmPP + y[22])
        J43 = (kDephosPP*PPtot*y[19])/(KmPP + y[19])
        J44 = (kDephosPP*PPtot*y[21])/(KmPP + y[21])
        J45 = (kPhosAMPK*y[8]*y[23])/(KmAMPK + y[23])
        J46 = (kPhosAMPK*y[17]*y[23])/(KmAMPK + y[23])
        J47 = (kPhosAMPK*y[18]*y[23])/(KmAMPK + y[23])
        J48 = (kDephosPP1*PP1tot*y[24])/(KmPP1 + y[24])
        # Metabolic fluxes
        # glycolysis

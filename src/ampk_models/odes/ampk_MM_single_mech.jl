MM_single = @ODEmodel(
    ...
    x6'(t) =  (x1(t)*x4(t)-kOffAMP*x6(t))-((VmaxCaMKK*x6(t))/(KmCaMKK+x6(t)))-((VmaxLKB1*x6(t))/(KmLKB1+x6(t))),
    x7'(t) =  (x2(t)*x4(t)-kOffADP*x7(t))-((VmaxCaMKK*x7(t))/(KmCaMKK+x7(t)))-((VmaxLKB1*x7(t))/(KmLKB1+x7(t))),
    x8'(t) =  (x3(t)*x4(t)-kOffATP*x8(t))-((VmaxCaMKK*x8(t))/(KmCaMKK+x8(t)))+((VmaxPP*x11(t))/(KmPP+x11(t))),
    x9'(t) =  (x1(t)*x5(t)-kOffAMP*x9(t))+((VmaxCaMKK*x6(t))/(KmCaMKK+x6(t)))+((VmaxLKB1*x6(t))/(KmLKB1+x6(t))),
    x10'(t) =  (x2(t)*x5(t)-kOffADP*x10(t))+((VmaxCaMKK*x7(t))/(KmCaMKK+x7(t)))+((VmaxLKB1*x7(t))/(KmLKB1+x7(t))),
    x11'(t) =  (x3(t)*x5(t)-kOffATP*x11(t))+((VmaxCaMKK*x8(t))/(KmCaMKK+x8(t)))-((VmaxPP*x11(t))/(KmPP+x11(t))),

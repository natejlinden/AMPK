...
def ampk_qss_single_get_params():
     return {
        'KdAMP':(), # AMP binding
        'kCaMKK':(), # CaMKK
        'KmCaMKK':(),
...
def ampk_qss_single_get_states():
    return {
...
def ampk_qss_single_RHS(t, y, p):
    ...
    J2 = (p.kLKB1*p.LKB1tot*y.AMPK)/(p.KmLKB1 + y.AMPK)
...
def ampk_qss_single_RHS_sympyFluxVars():

ode = @ODEmodel(
    x0'(t) =  -(kOnAMP*x0(t)*x3(t)-kOffAMP*x5(t))-(kOnAMP*x0(t)*x4(t)-kOffAMP*x8(t))-(kOnAMP*x0(t)*x5(t)-kOffAMP*x11(t))-(kOnAMP*x0(t)*x6(t)-kOffAMP*x12(t))-(kOnAMP*x0(t)*x7(t)-kOffAMP*x13(t))-(kOnAMP*x0(t)*x8(t)-kOffAMP*x17(t))-(kOnAMP*x0(t)*x9(t)-kOffAMP*x18(t))-(kOnAMP*x0(t)*x10(t)-kOffAMP*x19(t))-(kForAK*x2(t)*x0(t)-kRevAK*x1(t)*x1(t)),
    x1'(t) =  -(kOnADP*x1(t)*x3(t)-kOffADP*x6(t))-(kOnADP*x1(t)*x4(t)-kOffADP*x9(t))-(kOnADP*x1(t)*x5(t)-kOffADP*x12(t))-(kOnADP*x1(t)*x6(t)-kOffADP*x14(t))-(kOnADP*x1(t)*x7(t)-kOffADP*x15(t))-(kOnADP*x1(t)*x8(t)-kOffADP*x18(t))-(kOnADP*x1(t)*x9(t)-kOffADP*x20(t))-(kOnADP*x1(t)*x10(t)-kOffADP*x21(t))-(2*kGly*x1(t)*x1(t))+2*(kForAK*x2(t)*x0(t)-kRevAK*x1(t)*x1(t))+(kHydro*x2(t)), # -((VmaxOxPhos*((x1(t)/Kadp)**n))/(1+((x1(t)/Kadp)**n))),
    x2'(t) =  -(kOnATP*x2(t)*x3(t)-kOffATP*x7(t))-(kOnATP*x2(t)*x4(t)-kOffATP*x10(t))-(kOnATP*x2(t)*x5(t)-kOffATP*x13(t))-(kOnATP*x2(t)*x6(t)-kOffATP*x15(t))-(kOnATP*x2(t)*x7(t)-kOffATP*x16(t))-(kOnATP*x2(t)*x8(t)-kOffATP*x19(t))-(kOnATP*x2(t)*x9(t)-kOffATP*x21(t))-(kOnATP*x2(t)*x10(t)-kOffATP*x22(t))+(2*kGly*x1(t)*x1(t))-(kForAK*x2(t)*x0(t)-kRevAK*x1(t)*x1(t))-(kHydro*x2(t)), # +((VmaxOxPhos*((x1(t)/Kadp)**n))/(1+((x1(t)/Kadp)**n))),
    # free AMPK
    ...
    x4'(t) =  -(kOnAMP*x0(t)*x4(t)-kOffAMP*x8(t))-(kOnADP*x1(t)*x4(t)-kOffADP*x9(t))-(kOnATP*x2(t)*x4(t)-kOffATP*x10(t))+(kPhosCaMKK*x23(t))-(kOnPP*x51(t)*x4(t)-kOffPP*x38(t)),
    # single AXP-AMPK complexes
    x5'(t) =  (kOnAMP*x0(t)*x3(t)-kOffAMP*x5(t))-(kOnAMP*x0(t)*x5(t)-kOffAMP*x11(t))-(kOnADP*x1(t)*x5(t)-kOffADP*x12(t))-(kOnATP*x2(t)*x5(t)-kOffATP*x13(t))-(kOnCaMKK*x49(t)*x5(t)-kOffCaMKK*x24(t))-(kOnLKB1*x50(t)*x5(t)-kOffLKB1*x33(t)),
    x6'(t) =  (kOnADP*x1(t)*x3(t)-kOffADP*x6(t))-(kOnAMP*x0(t)*x6(t)-kOffAMP*x12(t))-(kOnADP*x1(t)*x6(t)-kOffADP*x14(t))-(kOnATP*x2(t)*x6(t)-kOffATP*x15(t))-(kOnCaMKK*x49(t)*x6(t)-kOffCaMKK*x25(t))-(kOnLKB1*x50(t)*x6(t)-kOffLKB1*x34(t)),
    ...
    x9'(t) =  (kOnADP*x1(t)*x4(t)-kOffADP*x9(t))-(kOnAMP*x0(t)*x9(t)-kOffAMP*x18(t))-(kOnADP*x1(t)*x9(t)-kOffADP*x20(t))-(kOnATP*x2(t)*x9(t)-kOffATP*x21(t))+(kPhosCaMKK*x25(t))+(kPhosLKB1*x34(t)),
    ...
    x11'(t) =  (kOnAMP*x0(t)*x5(t)-kOffAMP*x11(t))-(kOnCaMKK*x49(t)*x11(t)-kOffCaMKK*x27(t))-(kOnLKB1*x50(t)*x11(t)-kOffLKB1*x35(t)),
    x12'(t) =  (kOnAMP*x0(t)*x6(t)-kOffAMP*x12(t))+(kOnADP*x1(t)*x5(t)-kOffADP*x12(t))-(kOnCaMKK*x49(t)*x12(t)-kOffCaMKK*x28(t))-(kOnLKB1*x50(t)*x12(t)-kOffLKB1*x36(t)),
    ...
    # CaMKK complexes
    x49'(t) =  -(kOnCaMKK*x49(t)*x3(t)-kOffCaMKK*x23(t))+(kPhosCaMKK*x23(t))-(kOnCaMKK*x49(t)*x5(t)-kOffCaMKK*x24(t))+(kPhosCaMKK*x24(t))-(kOnCaMKK*x49(t)*x6(t)-kOffCaMKK*x25(t))+(kPhosCaMKK*x25(t))-(kOnCaMKK*x49(t)*x7(t)-kOffCaMKK*x26(t))+(kPhosCaMKK*x26(t))-(kOnCaMKK*x49(t)*x11(t)-kOffCaMKK*x27(t))+(kPhosCaMKK*x27(t))-(kOnCaMKK*x49(t)*x12(t)-kOffCaMKK*x28(t))+(kPhosCaMKK*x28(t))-(kOnCaMKK*x49(t)*x13(t)-kOffCaMKK*x29(t))+(kPhosCaMKK*x29(t))-(kOnCaMKK*x49(t)*x14(t)-kOffCaMKK*x30(t))+(kPhosCaMKK*x30(t))-(kOnCaMKK*x49(t)*x15(t)-kOffCaMKK*x31(t))+(kPhosCaMKK*x31(t))-(kOnCaMKK*x49(t)*x16(t)-kOffCaMKK*x32(t))+(kPhosCaMKK*x32(t)),
    x23'(t) =  (kOnCaMKK*x49(t)*x3(t)-kOffCaMKK*x23(t))-(kPhosCaMKK*x23(t)),
    x24'(t) =  (kOnCaMKK*x49(t)*x5(t)-kOffCaMKK*x24(t))-(kPhosCaMKK*x24(t)),
    ...
    y1(t) = x44(t) / (x43(t) + x44(t) + x45(t) + x46(t) + x47(t) + x48(t))
)
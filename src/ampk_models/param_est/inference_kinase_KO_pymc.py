...
def parse_args(raw_args=None):
    ...
    """
    parser=argparse.ArgumentParser(description="Run MCMC for AMPK models w/LKB1 and CaMKK2 KO.")
    ...
    parser.add_argument("-LKB1_KO_data_file", type=str, help="path to the data file. Should be a NPZ with the following objects: \
                        'times', 'mean', 'std_constant', and 'std'.")
    parser.add_argument("-CaMKK2_KO_data_file", type=str, help="path to the data file. \
                        Should be a NPZ with the following objects: \
                        'times', 'mean', 'std_constant', and 'std'.")

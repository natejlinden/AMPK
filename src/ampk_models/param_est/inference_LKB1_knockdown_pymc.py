...
def parse_args(raw_args=None):
    ...
    """
    parser=argparse.ArgumentParser(description="Run MCMC for AMPK models w/LKB1 KD.")
    ...
    parser.add_argument("-LKB1_KD_data_file", type=str, help="path to the data file. Should be a NPZ with the following objects: \
                        'times', 'mean', 'std_constant', and 'std'.")
...
def main(raw_args=None):
    ...
    # LKB1 KD
    data_LKB1_KD, data_std_LKB1_KD, _ = load_data(args.LKB1_KD_data_file, to_seconds=True, constant_std=False)
    data_LKB1_KD = data_LKB1_KD.reshape(1, len(data_LKB1_KD))
    data_std_LKB1_KD = data_std_LKB1_KD.reshape(1, len(data_std_LKB1_KD))
    ...
    with pm_model:
        ...
        # induce LKB1 KD by changing the parameters to the LKB1 KD values
        for param in LKB1_KD_params:
            priors[param] = 0.0
        
        prediction_LKB1_KD = pm.Deterministic('prediction_LKB1_KD', 
                                              sol_op(*[priors[param] for param in model_info['params']]))
        ...
        llike_LKB1_KD = pm.Normal("llike_LKB1_KD", mu=prediction_LKB1_KD, 
                                  sigma=data_std_LKB1_KD, observed=data_LKB1_KD)
